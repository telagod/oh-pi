...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "provider.detected": "Detected existing providers: {list}. Import?",
  ...
  zh: {
    ...
    "provider.detected": "检测到已有 Provider: {list}，是否导入？",
  ...
  fr: {
    ...
    "provider.detected": "Fournisseurs existants détectés : {list}. Importer ?",
